...
function front_pdf(first_name,last_name,id,image,emp_id){
    ...
    <div class="two-div-sec">
       ...
       <div class="right-img-sec"><img src="/home/next/git/NEXT-HCMS/static/employee_id_card_photos/${emp_id}.png"/></div>
    </div>
    <footer><img src="/home/next/git/NEXT-HCMS/static/new_id_card_images/footer.jpg"></footer>
 </div>`
...
function back_pdf(data,i){
	...
	<span class="blood">${data[i].blood_group}</span>
		...
		+91 422-2971111/1112/1113 <img src="/home/next/git/NEXT-HCMS/static/new_id_card_images/phone.png" width="4%" /><br>www.nexttechnosolutions.com <img src="/home/next/git/NEXT-HCMS/static/new_id_card_images/web.png" width="4%" /> <br></span><br><br>
		</div>
		</div>
		<div class="back-footer"><img src="/home/next/git/NEXT-HCMS/static/new_id_card_images/footer.jpg"></div>
		</div>`
