...
if((localStorage.getItem('id') != null) && (localStorage.getItem('id') != '')){
	...
	if(activeTabHeaderID != 'tab_payslip' && activeTabHeaderID != 'tab_report' && activeTabHeaderID != 'tab_banking'){
		$("."+activeTabHeaderID).DateTimePicker({
			dateFormat: "dd-MM-yyyy",
			//minDate: new Date(),
		});
	}else if(activeTabHeaderID == 'tab_report'){
		$(".report_tab").DateTimePicker({
			dateFormat: "dd-MMM-yyyy",
			//minDate: new Date(),
		});
	}else if(activeTabHeaderID == 'tab_banking'){
		$(".tab_banking").DateTimePicker({
			dateFormat: "dd-MMM-yyyy",
			//minDate: new Date(),
		});
	}
