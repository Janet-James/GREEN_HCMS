	...
	$.ajax(
			{
				...
				success: function (json_data) {
					...
					$("#hr_salary_con_variable").val(data.datas[0].variable);
					if(data.datas[0].grade)
					{
					$("#hr_salary_con_grade").val(data.datas[0].grade).trigger('change');
					}
					if(data.datas[0].nationality_check == true)
					{
					$('#hr_salary_con_nationals_check').prop('checked', true);
					}	
					else
					{
					$('#hr_salary_con_nationals_check').prop('checked', false);
					}
...
/*	if (status == 'create'){
	...
	salary_contract_form_value['variable'] = validationFields(salary_contract_form_value['variable']);
	if (salary_contract_form_value['national_check']==undefined)
		{salary_contract_form_value['national_check']=false}
	else	
		{salary_contract_form_value['national_check']=true}
	console.log(salary_contract_form_value)
	salary_contract_list = [];
...
function salary_contract_clear(){
	...
	$('#hr_salary_con_variable').val(''); 
	$('#hr_salary_con_nationals_check').prop('checked', false);
	$('#hr_salary_con_grade').val('0').trigger('change');
...
if (employee_id){
	$.ajax({	
		...
		if(data){
			...
			if(data.variable[0])
			{
			$("#hr_salary_con_variable").val(data.variable[0].variable)
			}
			else
			{
			$("#hr_salary_con_variable").val('')
