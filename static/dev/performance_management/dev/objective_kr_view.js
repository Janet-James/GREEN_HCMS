		...
		$.ajax({
			...
			if(json_data.status == 'NTE_01'){
				if(assign_type=="Employee"){
					...
					$("#assign_type_display_id").removeClass("col-md-6")
					$("#assign_type_display_id").addClass("col-md-3")
					$("#employee_variable_div").show();
					$("#organization_div").css('display','none')
					$("#organization_unit_div").css('display','none')
					$("#department_div").css('display','none')
					$('#obj_set_org').val('')
					...
					$("#assign_type_display_id").removeClass("col-md-3")
					$("#assign_type_display_id").addClass("col-md-6")
					$("#employee_variable_div").hide();
					$("#employee_div").css('display','none')
...
function add_update_objective_setting(){
	...
	data = {'strategic_objective_description':objective_name,'start_date':start_date,'end_date':end_date,'objective_plan_type':obj_plan_type,'assigned_type':assign_type,'month':month,'year':year,'quarter':quarter,'variable':variable,'objective_id':objective_id,csrfmiddlewaretoken:getCookie('csrftoken')}
...
//	$('#Add_objective_Modal').modal("show")
	...
	$.ajax({
		...
		$("#obj_set_variable").val(data[0].variable)
