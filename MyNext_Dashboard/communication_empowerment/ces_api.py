    ...
    try:
        if data:
           ...
           if attachment_id==0:
                 attachment_id=None
           if user_id:
              print "usesss--->", user_id
              cur.execute(query.fetch_hcms_query(config.ce_module,config.api_fetch_auth_user).format(user_id))
              active_auth_user=dictfetchall(cur)
              print "active_suther_user",active_auth_user
              if active_auth_user :
                ...
                print "service_call_id--",service_call_id
                if service_call_id:
                     if service_type==1:
                        service_group='HCM'
                     ...
                     json_data['status']='NTE_01'
                     json_data['msg']='success'
                     print "sssssssssss",active_auth_user, active_auth_user[0]
                     ...
                     print "Group mail--->",group_mail_detail, group_mail_detail[0]
...
def communication_response_submit(request):
    ...
    json_data={}
    ticket_number=''
    print "possssssssssssssssssss",post
        ...
        if data:
           ...
           if user_id:
            ...
            if active_auth_user :
                ...
                print "qqqqqqqqqq-->", query_formation
