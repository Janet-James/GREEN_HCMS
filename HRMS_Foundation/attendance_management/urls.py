...
import attendance,past_attendance,kiosk,holiday_list,org_structure,leave_balance,leave,reporting_builder,upload_attendance
...
urlpatterns = [
    ...
    #Upload Attendance
    url(r'attendance_biometric_upload/$',upload_attendance.attendance_biometric_upload,name='attendance_biometric_upload'),
    url(r'attendance_upload_getall/$',upload_attendance.AttendanceUploadDataGetall,name='AttendanceUploadDataGetall'),
    url(r'attendance_upload_getbyid/$',upload_attendance.AttendanceUploadDataGetById,name='AttendanceUploadDataGetById'),
