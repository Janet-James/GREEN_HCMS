...
class BankingPayer(BaseModel):    
    organization = models.ForeignKey(OrganizationInfo,related_name='banking_payer_org', on_delete=models.CASCADE,blank = True ,null = True)
    payer_description = models.TextField(null=True, blank=True)
    payer_bank_code = models.CharField(max_length=10,null = True)
    payer_branch_code = models.CharField(max_length=10,null = True)
    payer_account_type = models.CharField(max_length=10,null = True)
    payer_account_no = models.CharField(max_length=30,null = True)
    class Meta:
        db_table = 'payroll_banking_payer'
...
class SalaryContract(BaseModel):
    ...
    nationality_check = models.BooleanField()
...
class PaymentAdvices(BaseModel):
	...
	banking_payer = models.ForeignKey(BankingPayer,related_name='banking_payer_id', on_delete=models.CASCADE,blank = True ,null = True)
