...
import banking_payer
import banking_format
...
from .banking_payer import *
from .banking_format import *
...
urlpatterns = [
   ...
   ## Banking Payer
    url(r'^banking_payer_form/$',PayrollBankingPayer.as_view(), name='banking_payer_form'),
    url(r'^banking_payer_create/$',banking_payer.BankingPayerCreate,name='banking_payer_create'),
    url(r'^banking_payer_table_display/$',banking_payer.HCMSBankingPayerTblDisplay,name='Banking Payer Table Display'),
    url(r'^banking_payer_table_row_click/$',banking_payer.HCMSBankingPayerRowClick,name='Banking Payer Row Click'),
	
   ## Banking Format
    ## Report
    url(r'^bank_format_emploee_id/$',banking_format.HCMSBankingFormat,name='Banking Format Create'),
    url(r'^bank_format_org_based_emploee/$',banking_format.HCMSOrgBasedEmployee,name='OrgBasedEmployee'),
]
