...
#                                final_data_value['lop_hr_count'] = lop_hr_count
    ...
    #                                 fig.set_figwidth(7)
                                    ...
                                    month_image_name = '/home/next/.green_hcms/uploads/payslip_images/mon_rating_chart_'+str(employee_id)+'_'+file_date_replace+''
                                ...
                                #ax.plot(x, y)
                                    ...
                                    file_date_replace = file_date.replace(' ', '_')
                                    bvr_image_name = '/home/next/.green_hcms/uploads/payslip_images/bvr_chart_'+str(employee_id)+'_'+file_date_replace+''
...
#                                             leadership_slab_value = float(leadership_value[0]['value_return']) * ctc_amount / 100    
                                    ...
                                    if total_lvr_amount > 0:
                                        ...
                                        file_date_replace = file_date.replace(' ', '_')
                                        lvr_image_name = '/home/next/.green_hcms/uploads/payslip_images/lvr_rating_chart_'+str(employee_id)+'_'+file_date_replace+''
...
#                                    current_date = datetime.datetime.today().strftime("%d/%m/%Y")
                           ...
                           file_date_replace = file_date.replace(' ', '_')
                           year_date_image_name = '/home/next/.green_hcms/uploads/payslip_images/year_date_chart_'+str(employee_id)+'_'+file_date_replace+''
                           plt.savefig(year_date_image_name, dpi=600, format='png', bbox_inches='tight')
                           plt.close()   
                           final_data_value['year_date_image_name'] = year_date_image_name
...
def my_payslip_pdf(result_data):
    ...
    for a in result_data["exp_details"]:
        ...
        name_file = '/home/next/.green_hcms/uploads/payslip/temp_Payslip_of_'+a["employee_data_val"][0]["employee_name"]+ '_for_' +payslip_month+'_'+payslip_year+'.pdf'
...
#         resultPdf = open('/home/next/.green_hcms/uploads/payslip/Payslip_of_'+a["employee_data_val"][0]["employee_name"]+ '_for_' +payslip_month+'_'+payslip_year+'.pdf', 'wb')
...
#         resultPdf.close()
        ...
        if emp_details:
            ...
            #print"*************************************************",emp_password    
            pdffile = open(r'/home/next/.green_hcms/uploads/payslip/temp_Payslip_of_'+a["employee_data_val"][0]["employee_name"]+ '_for_' +payslip_month+'_'+payslip_year+'.pdf', "rb")
            pdfReader = PyPDF2.PdfFileReader(pdffile)
            pdfWriter = PyPDF2.PdfFileWriter()
            for pageNum in range(pdfReader.numPages):
                pdfWriter.addPage(pdfReader.getPage(pageNum))
            pdfWriter.encrypt(emp_password.encode('utf-8'))
            resultPDF = open(r'/home/next/.green_hcms/uploads/payslip/Payslip_of_'+a["employee_data_val"][0]["employee_name"]+ '_for_' +payslip_month+'_'+payslip_year+'.pdf', "wb")
            pdfWriter.write(resultPDF)
            resultPDF.close()
            os.remove('/home/next/.green_hcms/uploads/payslip/temp_Payslip_of_'+a["employee_data_val"][0]["employee_name"]+ '_for_' +payslip_month+'_'+payslip_year+'.pdf')
