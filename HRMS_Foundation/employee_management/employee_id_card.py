...
COALESCE(attch.name,'no_data.png') as image_name,COALESCE(employee_add_more_info.emer_contact1,''),COALESCE(employee_add_more_info.emer_contact2,''),
COALESCE(employee_add_more_info.emer_contact3,'')
...
def HCMSPdfPrint(request):
    #template_name = "hrms_foundation/employee_management/employee_id_card.html"
    css = ['/home/next/git/NEXT-HCMS/static/ui/css/new-profile-design.css']
