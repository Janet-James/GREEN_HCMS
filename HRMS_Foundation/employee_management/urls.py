...
import employee,organization,employeeList,org_unit,attachment,team_details,documentUpload,hrd_dashboard,employee_assets,employee_id_card,employee_offer,meet_our_expertise,exit_our_expertise,social_media
...
urlpatterns = [
   # Organization Unit 
    ...
    #social media
    url(r'^social_media/$',websiteSocialMedia.as_view(), name='website_social_media_reqeust'),
]
