...
class ThreadUrl(threading.Thread):
    ...
    def run(self):
        ...
        fromaddr = formataddr((str(Header(fromaddress, 'utf-8')), 'lumino@nexttechnosolutions.co.in'))
        print"fffff",fromaddress,fromaddr
        #pwd = self.host[6]
        pwd = "N3xt@Lumin0"
	...
	if 'HCMS Password change - OTP' != str(self.host[9]):
		...
		body = self.host[0]
                print"dddddddddd",fromaddress,fromaddr,msg
...
if __name__ == '__main__':
	logging.basicConfig(filename='/home/nextaps/Green_HCMS_API/logger/asyn_mail.log', level=logging.INFO)
