strategic_objective_description = "strategic_objective_description"
...
objective_plan_type = "objective_plan_type"
...
assigned_type = 'assigned_type'
kr_data = "kr_data"
objective_setting="Performance_Management/objective_setting"
...
tree_department_existcheck_query='tree_department_existcheck_query'
...
msg_kr_delete_success='Remove Key Results and try again'
...
update_tree_department_query='update_tree_department_query'
organization_view_query='organization_view_query'
organization_unit_view_query='organization_unit_view_query'
year='year'
month='month'
quarter='quarter'
variable='variable'
insert_tree_department_query='insert_tree_department_query'
objective_data_retrieval_query='objective_data_retrieval_query'
team_emp_fetch='team_emp_fetch'
role_permission_fetch='role_permission_fetch'
user_role_okr_access='user_role_okr_access'
employee_team_detail_fetch='employee_team_detail_fetch'